    ...
    <nav class="navbar navbar-expand-lg bg-white border-bottom sticky-top">
        <div class="container">
            ...
            <div class="d-flex gap-2">
                <a class="btn btn-outline-primary" href="/vista/clientes">Volver a clientes</a>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body p-4 p-lg-5">
                            ...
                            <form th:action="${formAction}" th:object="${clienteForm}" method="post" class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="empresa" th:field="*{empresa}" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label for="telefono" class="form-label fw-semibold">Telefono</label>
                                    <input id="telefono" th:field="*{telefono}" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="correo" class="form-label fw-semibold">Correo</label>
                                    <input id="correo" th:field="*{correo}" type="email" class="form-control" required>
                                </div>
                                <div class="col-12 d-flex gap-2 pt-2">
                                    <button type="submit" class="btn btn-primary">Guardar cliente</button>
                                    <a href="/vista/clientes" class="btn btn-outline-secondary">Cancelar</a>
                                </div>
                            </form>
                        </div>
                    </div>
